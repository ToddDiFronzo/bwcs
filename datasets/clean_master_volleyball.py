...
df = pd.read_csv(r'C:/Users/Todd/Desktop/python_learn/python_data_analytics/buildweek/datasets/Master_volleyball.csv')
...
df1['sport'].fillna('Volleyball', inplace=True)
print(df1.head())
